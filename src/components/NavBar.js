        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto text-dark">
              ...
              <Nav.Link href="" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('projects')}>Dexscreener Chart</Nav.Link>
              <Nav.Link href="" className={activeLink === 'exp' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('exp')}>Buy</Nav.Link>
            </Nav>
